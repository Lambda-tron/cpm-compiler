...
clean:
		rm -f parser.tab.* lex.yy.c* compiler stack.hh position.hh location.hh tree.dot tree.pdf cfg.dot cfg.pdf cfg.png out.cpp out.s out.bc out assemblyVersion CPPVersion
		rm -R compiler.dSYM
